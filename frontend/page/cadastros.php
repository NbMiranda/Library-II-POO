...
<body>
    ...
    foreach ($books->readLimit() as $key) {
        ...
        <div class='container text-center'>
            <div class='row'>
                <div class='sqlResult col-md-3 col-sm-4'> <p>$book_name</p></div>
                <div class='sqlResult col-md-3 col-sm-3'> <p>$writer_name</p></div>
                <div class='sqlResult col-md-3 col-sm-4'><p>$genre $other_genre</p></div>
                <div class='sqlResult col-md-3 col-sm-1 text-center'> 
